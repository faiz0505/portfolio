export default function SocialLinks({ className = "flex items-center gap-4" }) {
  return (
    <div className={className}>
      ...
      <a href="https://www.instagram.com/faaiz_ali_03" target="_blank" rel="noopener noreferrer" className="p-3 bg-[#1a1a1a]/80 hover:bg-white/5 border border-white/5 rounded-full text-[#E1306C] transition-all duration-300 hover:scale-110 shadow-lg backdrop-blur-md">
